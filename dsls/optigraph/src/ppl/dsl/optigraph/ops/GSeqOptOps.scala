...
trait GSeqOptOpsExp extends GSeqOps with VariablesExp with BaseFatExp {
  this: OptiGraphExp =>
...
trait BaseGenGSeqOptOps extends GenericFatCodegen {
  val IR: GSeqOptOpsExp
  import IR._
}

trait ScalaGenGSeqOptOps extends BaseGenGSeqOptOps with ScalaGenFat {
  val IR: GSeqOptOpsExp
  import IR._
