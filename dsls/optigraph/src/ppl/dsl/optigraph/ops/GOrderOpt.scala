...
trait GOrderOptOpsExp extends GOrderOps with VariablesExp with BaseFatExp {
  this: OptiGraphExp =>
...
trait BaseGenGOrderOptOps extends GenericFatCodegen {
  val IR: GOrderOptOpsExp
  import IR._
}

trait ScalaGenGOrderOptOps extends BaseGenGOrderOptOps with ScalaGenFat {
  val IR: GOrderOptOpsExp
  import IR._
