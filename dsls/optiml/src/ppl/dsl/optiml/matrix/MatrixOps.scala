...
trait MatrixOps extends DSLType with Variables {
  ...
  class matOpsCls[A:Manifest](x: Rep[Matrix[A]]) {
    ...
    def update(i: Rep[Int], y: Rep[Vector[A]])(implicit ctx: SourceContext) = updateRow(i, y)
    def updateRow(row: Rep[Int], y: Rep[Vector[A]])(implicit ctx: SourceContext) = matrix_updaterow(x,row,y)
    def +=(y: Rep[Vector[A]])(implicit ctx: SourceContext) = insertRow(x.numRows,y)
    def ++=(y: Rep[Matrix[A]])(implicit ctx: SourceContext) = insertAllRows(x.numRows,y)
    def insertRow(pos: Rep[Int], y: Rep[Vector[A]])(implicit ctx: SourceContext) = matrix_insertrow(x,pos,y)
    def insertAllRows(pos: Rep[Int], y: Rep[Matrix[A]])(implicit ctx: SourceContext) = matrix_insertallrows(x,pos,y)
    def insertCol(pos: Rep[Int], y: Rep[Vector[A]])(implicit ctx: SourceContext) = matrix_insertcol(x,pos,y)
    ...
    def *(y: Rep[Vector[A]])(implicit a: Arith[A], o: Overloaded1, ctx: SourceContext) = matrix_times_vector(x,y)
    ...
    def mapRows[B:Manifest](f: Rep[MatrixRow[A]] => Rep[Vector[B]])(implicit ctx: SourceContext) = matrix_maprows(x,f)
    ...
    def reduceRows(f: (Rep[Vector[A]],Rep[Vector[A]]) => Rep[Vector[A]])(implicit ctx: SourceContext) = matrix_reducerows(x,f)
    def filterRows(pred: Rep[MatrixRow[A]] => Rep[Boolean])(implicit ctx: SourceContext) = matrix_filterrows(x,pred)
    def groupRowsBy[K:Manifest](pred: Rep[Vector[A]] => Rep[K])(implicit ctx: SourceContext) = matrix_grouprowsby(x, pred)
  ...
  def matrix_vview[A:Manifest](x: Rep[Matrix[A]], start: Rep[Int], stride: Rep[Int], length: Rep[Int], isRow: Rep[Boolean])(implicit ctx: SourceContext): Rep[Vector[A]]
  ...
  def matrix_updaterow[A:Manifest](x: Rep[Matrix[A]], row: Rep[Int], y: Rep[Vector[A]])(implicit ctx: SourceContext): Rep[Unit]
  def matrix_insertrow[A:Manifest](x: Rep[Matrix[A]], pos: Rep[Int], y: Rep[Vector[A]])(implicit ctx: SourceContext): Rep[Unit]
  def matrix_insertallrows[A:Manifest](x: Rep[Matrix[A]], pos: Rep[Int], y: Rep[Matrix[A]])(implicit ctx: SourceContext): Rep[Unit]
  def matrix_insertcol[A:Manifest](x: Rep[Matrix[A]], pos: Rep[Int], y: Rep[Vector[A]])(implicit ctx: SourceContext): Rep[Unit]
  ...
  def matrix_times_vector[A:Manifest:Arith](x: Rep[Matrix[A]], y: Rep[Vector[A]])(implicit ctx: SourceContext): Rep[Vector[A]]
  ...
  def matrix_sumrow[A:Manifest:Arith](x: Rep[Matrix[A]])(implicit ctx: SourceContext): Rep[Vector[A]]
  def matrix_sumcol[A:Manifest:Arith](x: Rep[Matrix[A]])(implicit ctx: SourceContext): Rep[Vector[A]]
  ...
  def matrix_minrow[A:Manifest:Ordering:HasMinMax](x: Rep[Matrix[A]])(implicit ctx: SourceContext): Rep[Vector[A]]
  def matrix_max[A:Manifest:Ordering:HasMinMax](x: Rep[Matrix[A]])(implicit ctx: SourceContext): Rep[A]
  def matrix_maxrow[A:Manifest:Ordering:HasMinMax](x: Rep[Matrix[A]])(implicit ctx: SourceContext): Rep[Vector[A]]
  ...
  def matrix_maprows[A:Manifest,B:Manifest](x: Rep[Matrix[A]], f: Rep[MatrixRow[A]] => Rep[Vector[B]])(implicit ctx: SourceContext): Rep[Matrix[B]]
  def matrix_maprowstovec[A:Manifest,B:Manifest](x: Rep[Matrix[A]], f: Rep[MatrixRow[A]] => Rep[B], isRow: Rep[Boolean])(implicit ctx: SourceContext): Rep[Vector[B]]
  ...
  def matrix_reducerows[A:Manifest](x: Rep[Matrix[A]], f: (Rep[Vector[A]],Rep[Vector[A]]) => Rep[Vector[A]])(implicit ctx: SourceContext): Rep[Vector[A]]
  def matrix_filterrows[A:Manifest](x: Rep[Matrix[A]], pred: Rep[MatrixRow[A]] => Rep[Boolean])(implicit ctx: SourceContext): Rep[Matrix[A]]
  def matrix_grouprowsby[A:Manifest,K:Manifest](x: Rep[Matrix[A]], pred: Rep[Vector[A]] => Rep[K])(implicit ctx: SourceContext): Rep[Vector[Matrix[A]]] 
...
*/
  ...
  def matrix_updaterow[A:Manifest](x: Exp[Matrix[A]], row: Exp[Int], y: Exp[Vector[A]])(implicit ctx: SourceContext) = reflectWrite(x)(MatrixUpdateRow(x,row,y))
  def matrix_insertrow[A:Manifest](x: Exp[Matrix[A]], pos: Exp[Int], y: Exp[Vector[A]])(implicit ctx: SourceContext) = reflectWrite(x)(MatrixInsertRow(x,pos,y))
  ...
  def matrix_insertcol[A:Manifest](x: Exp[Matrix[A]], pos: Exp[Int], y: Exp[Vector[A]])(implicit ctx: SourceContext) = reflectWrite(x)(MatrixInsertCol(x,pos,y))
  ...
  def matrix_times_vector[A:Manifest:Arith](x: Exp[Matrix[A]], y: Exp[Vector[A]])(implicit ctx: SourceContext) = {
  ...
  def matrix_maprows[A:Manifest,B:Manifest](x: Exp[Matrix[A]], f: Exp[MatrixRow[A]] => Exp[Vector[B]])(implicit ctx: SourceContext) = {
  ...
  def matrix_reducerows[A:Manifest](x: Exp[Matrix[A]], f: (Exp[Vector[A]],Exp[Vector[A]]) => Exp[Vector[A]])(implicit ctx: SourceContext) = {
  ...
  def matrix_grouprowsby[A:Manifest,K:Manifest](x: Exp[Matrix[A]], pred: Exp[Vector[A]] => Exp[K])(implicit ctx: SourceContext) = reflectPure(MatrixGroupRowsBy(x,pred))
  ...
  override def mirror[A:Manifest](e: Def[A], f: Transformer)(implicit ctx: SourceContext): Exp[A] = {
    (e match {
      ...
      case e@MatrixObjectDiag(x,y) => reflectPure(new { override val original = Some(f,e) } with MatrixObjectDiag(f(x),f(y))(e.m))(mtype(manifest[A]), implicitly[SourceContext])
