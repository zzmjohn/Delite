 ...
 */
trait OptiLA extends Interfaces with OptiLAScalaOpsPkg with RecordOps with DeliteCollectionOps with DeliteArrayOps
 ...
 */
trait OptiLAExp extends OptiLACompiler with InterfacesExp with OptiLAScalaOpsPkgExp with RecordOpsExp with FunctionBlocksExp with DeliteOpsExp with DeliteArrayOpsExp with VariantsOpsExp 
